                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{url('/contact')}}">Contact</a></li>
                          @guest
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4 border" href="{{route('register')}}">Register</a></li>
                        <li class="nav-item"><a class="nav-link px-lg-3 py-2mx-1 py-lg-4 border " href="{{route('login.user')}}">Login</a></li>
                        @endguest


                        @auth
                        <li class="nav-item"><a class="nav-link px-lg-3 py-2mx-1 py-lg-4 border " href="{{route('logout')}}">Logout</a></li>
                        @endauth
                    </ul>
                </div>
            </div>
